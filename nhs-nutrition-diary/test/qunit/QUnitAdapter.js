...
<head>
 ...
 var CS_env = {"projectHomeUrl": "/p/js-test-driver", "projectName": "js-test-driver", "profileUrl": null, "domainName": null, "relativeBaseUrl": "", "loggedInUserEmail": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/1729405847801014513", "token": null};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fjs-test-driver%2Fsource%2Fbrowse%2FJsTestDriver%2Fcontrib%2Fqunit%2Fsrc%2FQUnitAdapter.js&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fjs-test-driver%2Fsource%2Fbrowse%2FJsTestDriver%2Fcontrib%2Fqunit%2Fsrc%2FQUnitAdapter.js" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/js-test-driver/source/browse/JsTestDriver/">JsTestDriver</a><span class="sp">/&nbsp;</span><a href="/p/js-test-driver/source/browse/JsTestDriver/contrib/">contrib</a><span class="sp">/&nbsp;</span><a href="/p/js-test-driver/source/browse/JsTestDriver/contrib/qunit/">qunit</a><span class="sp">/&nbsp;</span><a href="/p/js-test-driver/source/browse/JsTestDriver/contrib/qunit/src/">src</a><span class="sp">/&nbsp;</span>QUnitAdapter.js</span>
 ...
 <li><a href="/p/js-test-driver/source/browse/JsTestDriver/contrib/qunit/src/QUnitAdapter.js?r=1706646400e12b788f40b282935d96e5615f6731" title="Previous">&lsaquo;1706646400e1</a></li>
...
><td class="source">QUnitAdapter<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_3

><td class="source">Version: 1.1.0<br></td></tr
><tr
...
><td class="source">Run qunit tests using JS Test Driver<br></td></tr
><tr
...
><td class="source">This provides almost the same api as qunit.<br></td></tr
><tr
...
><td class="source">Tests must run sychronously, which means no use of stop and start methods.<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_10

><td class="source">You can use jsUnit Clock object to deal with timeouts and intervals:<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_11

><td class="source">http://googletesting.blogspot.com/2007/03/javascript-simulating-time-in-jsunit.html<br></td></tr
><tr
...
><td class="source">The qunit #main DOM element is not included. If you need to do any DOM manipulation<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_14

><td class="source">you need to set it up and tear it down in each test.<br></td></tr
><tr
...
><td class="source">	if(!(window.equiv)) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_20

><td class="source">		throw new Error(&quot;QUnitAdapter.js - Unable to find equiv function. Ensure you have added equiv.js to the load section of your jsTestDriver.conf&quot;);<br></td></tr
><tr
...
><td class="source">	var QUnitTestCase;<br></td></tr
><tr
...
><td class="source">    window.module = function(name, lifecycle) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_26

><td class="source">        QUnitTestCase = TestCase(name);<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_27

><td class="source">        QUnitTestCase.prototype.lifecycle = lifecycle || {};<br></td></tr
><tr
...
><td class="source">    window.test = function(name, expected, test) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_31

><td class="source">    	QUnitTestCase.prototype[&#39;test &#39; + name] = function() {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_32

><td class="source">        	if(this.lifecycle.setup) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_33

><td class="source">        		this.lifecycle.setup();<br></td></tr
><tr
...
><td class="source">       		if(expected.constructor === Number) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_36

><td class="source">       			expectAsserts(expected);	<br></td></tr
><tr
...
><td class="source">       			test = expected;<br></td></tr
><tr
...
><td class="source">       		test.call(this.lifecycle);<br></td></tr
><tr
...
><td class="source">			if(this.lifecycle.teardown) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_43

><td class="source">				this.lifecycle.teardown();<br></td></tr
><tr
...
><td class="source">    window.expect = function(count) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_49

><td class="source">        expectAsserts(count);<br></td></tr
><tr
...
><td class="source">    window.ok = function(actual, msg) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_53

><td class="source">        assertTrue(msg ? msg : &#39;&#39;, !!actual);<br></td></tr
><tr
...
><td class="source">    window.equals = function(a, b, msg) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_57

><td class="source">        assertEquals(msg ? msg : &#39;&#39;, b, a);<br></td></tr
><tr
...
><td class="source">    window.start = window.stop = function() {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_61

><td class="source">        fail(&#39;start and stop methods are not available when using JS Test Driver.\n&#39; +<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_62

><td class="source">            &#39;Use jsUnit Clock object to deal with timeouts and intervals:\n&#39; + <br></td></tr
><tr
...
><td class="source">    window.same = function(a, b, msg) {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_67

><td class="source">        assertTrue(msg ? msg : &#39;&#39;, window.equiv(b, a));<br></td></tr
><tr
...
><td class="source">    window.reset = function() {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_71

><td class="source">    	fail(&#39;reset method is not available when using JS Test Driver&#39;);<br></td></tr
><tr
...
><td class="source">    window.isLocal = function() {<br></td></tr
><tr
...
><td class="source">    window.QUnit = {<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_79

><td class="source">    	equiv: window.equiv,<br></td></tr
><tr
id=sl_svnf527fd5bcbe216ba45b2237a9582c4e434aefd64_80

><td class="source">    	ok: window.ok<br></td></tr
><tr
...
><td class="source">	module(&#39;Default Module&#39;);<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/js-test-driver/source/detail?spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64&amp;r=2fe29a8065d0c269aff086ccafd56202b8f1f91f">2fe29a8065d0</a>
 by karl.okeeffe &lt;karl.oke...@205c1ca0-44cf-11de-84a6-839b6ed6c72e&gt;
 on Apr 9, 2010
 &nbsp; <a href="/p/js-test-driver/source/diff?spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64&r=2fe29a8065d0c269aff086ccafd56202b8f1f91f&amp;format=side&amp;path=/JsTestDriver/contrib/qunit/src/QUnitAdapter.js&amp;old_path=/JsTestDriver/contrib/qunit/src/QUnitAdapter.js&amp;old=1706646400e12b788f40b282935d96e5615f6731">Diff</a>
 </div>
 <pre>Upped version number within
QUnitAdapter.js file.
Added an explicit check for the equiv
function.

git-svn-id: https://js-test-
driver.googlecode.com/svn/trunk@556
205c1ca0-44cf-11de-84a6-839b6ed6c72e
</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/js-test-driver/source/detail?r=2fe29a8065d0c269aff086ccafd56202b8f1f91f&spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64';
 var publish_url = '/p/js-test-driver/source/detail?r=2fe29a8065d0c269aff086ccafd56202b8f1f91f&spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/JsTestDriver/contrib/qunit/src/QUnitAdapter.js');
 changed_urls.push('/p/js-test-driver/source/browse/JsTestDriver/contrib/qunit/src/QUnitAdapter.js?r\x3d2fe29a8065d0c269aff086ccafd56202b8f1f91f\x26spec\x3dsvnf527fd5bcbe216ba45b2237a9582c4e434aefd64');
 
 var selected_path = '/JsTestDriver/contrib/qunit/src/QUnitAdapter.js';
 ...
 <option value="/p/js-test-driver/source/browse/JsTestDriver/contrib/qunit/src/QUnitAdapter.js?r=2fe29a8065d0c269aff086ccafd56202b8f1f91f&amp;spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64"
 selected="selected"
 ...
 <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=https%3A%2F%2Fcode.google.com%2Fp%2Fjs-test-driver%2Fsource%2Fbrowse%2FJsTestDriver%2Fcontrib%2Fqunit%2Fsrc%2FQUnitAdapter.js&amp;followup=https%3A%2F%2Fcode.google.com%2Fp%2Fjs-test-driver%2Fsource%2Fbrowse%2FJsTestDriver%2Fcontrib%2Fqunit%2Fsrc%2FQUnitAdapter.js"
 ...
 <a href="/p/js-test-driver/source/detail?spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64&r=1706646400e12b788f40b282935d96e5615f6731">1706646400e1</a>
 by karl.okeeffe &lt;karl.oke...@205c1ca0-44cf-11de-84a6-839b6ed6c72e&gt;
 on Apr 9, 2010
 &nbsp; <a href="/p/js-test-driver/source/diff?spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64&r=1706646400e12b788f40b282935d96e5615f6731&amp;format=side&amp;path=/JsTestDriver/contrib/qunit/src/QUnitAdapter.js&amp;old_path=/JsTestDriver/contrib/qunit/src/QUnitAdapter.js&amp;old=91582a8d0cf9acfe2f76510c90acc42b05b633d2">Diff</a>
 <br>
 <pre class="ifOpened">Variables set on the 'this' object
within are now available within setup,
teardown, and the tests themselves.

The test function now supports the
...</pre>
 </div>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/js-test-driver/source/detail?spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64&r=91582a8d0cf9acfe2f76510c90acc42b05b633d2">91582a8d0cf9</a>
 by karl.okeeffe@gmail.com &lt;karl.oke...@gmail.com@205c1ca0-44cf-11de-84a6-839b6ed6c72e&gt;
 on Nov 9, 2009
 &nbsp; <a href="/p/js-test-driver/source/diff?spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64&r=91582a8d0cf9acfe2f76510c90acc42b05b633d2&amp;format=side&amp;path=/JsTestDriver/contrib/qunit/src/QUnitAdapter.js&amp;old_path=/JsTestDriver/contrib/qunit/src/QUnitAdapter.js&amp;old=34afffd6f118148280d3d0bb242dad608aa501c7">Diff</a>
 <br>
 <pre class="ifOpened">Upped version number.

git-svn-id: https://js-test-
driver.googlecode.com/svn/trunk@476
205c1ca0-44cf-11de-84a6-839b6ed6c72e
</pre>
 </div>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/js-test-driver/source/detail?spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64&r=34afffd6f118148280d3d0bb242dad608aa501c7">34afffd6f118</a>
 by karl.okeeffe@gmail.com &lt;karl.oke...@gmail.com@205c1ca0-44cf-11de-84a6-839b6ed6c72e&gt;
 on Nov 9, 2009
 &nbsp; <a href="/p/js-test-driver/source/diff?spec=svnf527fd5bcbe216ba45b2237a9582c4e434aefd64&r=34afffd6f118148280d3d0bb242dad608aa501c7&amp;format=side&amp;path=/JsTestDriver/contrib/qunit/src/QUnitAdapter.js&amp;old_path=/JsTestDriver/contrib/qunit/src/QUnitAdapter.js&amp;old=7dbe2d0c49307ec32051deae718051a7569c1254">Diff</a>
 <br>
 <pre class="ifOpened">Fixed <a title="QUnit Adapter fails to run tests if you don't include a module" class=closed_ref href="/p/js-test-driver/issues/detail?id=64"> issue 64 </a>.
tests decalred without a module now
run.
...
...</pre>
 ...
 <a href="/p/js-test-driver/source/list?path=/JsTestDriver/contrib/qunit/src/QUnitAdapter.js&r=2fe29a8065d0c269aff086ccafd56202b8f1f91f">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//js-test-driver.googlecode.com/git/JsTestDriver/contrib/qunit/src/QUnitAdapter.js">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svnf527fd5bcbe216ba45b2237a9582c4e434aefd64': '/JsTestDriver/contrib/qunit/src/QUnitAdapter.js'}
 codereviews = CR_controller.setup(
 {"projectHomeUrl": "/p/js-test-driver", "projectName": "js-test-driver", "profileUrl": null, "domainName": null, "relativeBaseUrl": "", "loggedInUserEmail": null, "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/1729405847801014513", "token": null}, '', 'svnf527fd5bcbe216ba45b2237a9582c4e434aefd64', paths,
